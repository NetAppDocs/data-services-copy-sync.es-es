...
Se puede acceder a NetApp Copy and Sync a través de la consola de NetApp .
...
NetApp Copy and Sync es una plataforma de software como servicio (SaaS) que consta de un grupo de intermediarios de datos, una interfaz basada en la nube disponible a través de la consola de NetApp , y un origen y un destino.
