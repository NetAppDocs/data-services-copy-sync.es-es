...
---
= Configura HashiCorp Vault para un grupo de data broker de NetApp Copy and Sync
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
....
* Para obtener un token de usuario y el ID de su cuenta de NetApp Console ,link:api-sync.html["Consulte esta página en la documentación"] .
