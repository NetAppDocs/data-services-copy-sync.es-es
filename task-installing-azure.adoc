...
....
====
Los siguientes permisos solo son necesarios si planeas habilitar la link:task-creating-relationships.html["Configuración de sincronización continua"] en una relación de sincronización desde Azure a otra ubicación de almacenamiento en la nube:
...
El ámbito asignable debe configurarse como ámbito de suscripción y *no* como ámbito de grupo de recursos si tienes previsto implementar la sincronización continua en Azure.
...
Al implementar el agente de datos, debes elegir un método de autenticación para la máquina virtual: una contraseña o un par de claves pública y privada SSH.

Si necesitas ayuda para crear un par de claves, consulta link:https://docs.microsoft.com/en-us/azure/virtual-machines/linux/mac-create-ssh-keys["Documentación de Azure: Crear y usar un par de claves públicas y privadas SSH para máquinas virtuales Linux en Azure"^].
