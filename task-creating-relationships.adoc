...
** https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html["Configuración y detección de Azure NetApp Files"^]
...
** https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html["Descubriendo los clústeres de ONTAP"^]
...
Copy and Sync comienza a sincronizar los datos entre el origen y el destino. Las estadísticas de sincronización sobre cuánto tiempo tardó la sincronización, si se detuvo y cuántos archivos se copiaron, escanearon o eliminaron están disponibles. Luego puedes gestionar tus link:task-managing-relationships.html["relaciones de sincronización"], link:task-managing-data-brokers.html["Gestione sus corredores de datos"] o link:task-managing-reports.html#creating-reports["Crea informes para optimizar tu rendimiento y configuración"].
...
image:screenshot-sync-data-sense.png["Una captura de pantalla que muestra la página de integración de NetApp Data Classification que aparece después de iniciar una nueva sincronización directamente desde NetApp Data Classification."]

https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html["Aprenda a iniciar una relación de sincronización desde NetApp Data Classification"^].
