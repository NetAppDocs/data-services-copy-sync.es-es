...
summary: 'Si planea sincronizar datos de un almacenamiento de objetos a otro (por ejemplo, Amazon S3 a Azure Blob) mediante NetApp Copy and Sync, entonces debe preparar el grupo de agentes de datos antes de crear la relación de sincronización.' 
---
= Prepara un data broker para la sincronización de almacenamiento de objetos en NetApp Copy and Sync
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
