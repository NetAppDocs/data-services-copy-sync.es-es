...
---
= Requisitos de origen y destino para NetApp Copy and Sync
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Para añadir una clave de KMS gestionada por el cliente, tendrás que utilizar un data broker con el link:task-installing-gcp.html#permissions-required-for-the-service-account["permisos correctos"], y la clave debe estar en la misma región que el bucket.
